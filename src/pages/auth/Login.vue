      ...
      <div class="card p-8 shadow-xl">
        ...
        <form @submit.prevent="onSubmit" class="space-y-4">
          ...
          <div v-if="unverified" class="p-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800">
            <p class="text-xs font-semibold text-amber-700 dark:text-amber-400 mb-1">Email not verified</p>
            <p class="text-xs text-amber-600 dark:text-amber-500">We just resent a verification link to <strong>{{ form.email }}</strong>. Check your inbox and click the link to activate your account.</p>
          </div>
